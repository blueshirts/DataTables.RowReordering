/**
 * @file DataTables.RowReordering.js
 * @version 1.2.1
...
(function ($) {
    ...
    /**
     * @param int iIndexColumn - Position of the indexing column
     * @param String sURL - Server side page tat will be notified that order is changed
     * @param int iGroupingLevel - Defines that grouping is used
     */
